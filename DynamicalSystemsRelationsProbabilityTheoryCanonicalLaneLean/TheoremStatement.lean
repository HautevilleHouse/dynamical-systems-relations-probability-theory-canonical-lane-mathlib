import DynamicalSystemsRelationsProbabilityTheoryCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String :=
  "dynamical-systems-relations-probability-theory-canonical-lane"

def sourceDescription : String :=
  "Dynamical Systems Relations Probability Theory"

def sourceTheoremBoundary : { claimBoundary : String } :=
  { claimBoundary := "classical source boundary carried" }
